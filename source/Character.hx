...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'bandu':
				frames = Paths.getSparrowAtlas('characters/main/applecore/bandu');
			...
			case 'bambi-piss-3d':
				...
				animation.addByPrefix('singUP-alt', 'smash', 24, false);
		
				addOffset('danceLeft');
				addOffset('danceRight');
				addOffset('singUP-alt');
				addOffset("singUP", 0, 75);
				addOffset("singRIGHT", -75, 0);
				addOffset("singLEFT", 75, 0);
			...
			case 'unfair-junker':
				frames = Paths.getSparrowAtlas('characters/main/applecore/UNFAIR_GUY_FAICNG_FORWARD');
				animation.addByPrefix('idle', 'idle', 24, false);
