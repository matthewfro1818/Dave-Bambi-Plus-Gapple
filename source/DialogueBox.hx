...
class DialogueBox extends FlxSpriteGroup
{
	...
	public var noAa:Array<String> = ["dialogue/dave/dave_3d_scared", "dialogue/dave/dave_3d_festival", "dialogue/dave_furiosity", "dialogue/3d_bamb", "dialogue/unfairnessPortrait", 'dialogue/3d_bambi_disruption_portrait', 'dialogue/bandu_portrait', 'dialogue/3d_splitathon_dave_port', 'dialogue/3d_dave_wireframe_portrait', 'dialogue/3d_dave_og_portrait'];
	...
	public function new(talkingRight:Bool = true, ?dialogueList:Array<String>, playMusic:Bool = true)
	{
		...
		if (playMusic)
		{
			...
			{
				case 'house' | 'insanity' | 'splitathon' | 'shredder' | 'disability' | 'applecore' | 'algebra':
					FlxG.sound.playMusic(Paths.music('DaveDialogue'), 0);
				case 'furiosity' | 'polygonized' | 'cheating' | 'unfairness' | 'disruption' | 'wireframe' | 'interdimensional' | 'master':
